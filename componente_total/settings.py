"""
Django settings for componente_total project.
...
SECRET_KEY = 'django-insecure-8vk-w$q%+p6o83k55au)#^dbrgl-e5wgpgfe^b(kkpb3bd+dw*'
...
ROOT_URLCONF = 'componente_total.urls'
...
WSGI_APPLICATION = 'componente_total.wsgi.application'
